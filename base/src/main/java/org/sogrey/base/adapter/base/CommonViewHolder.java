...
public class CommonViewHolder {
     ...
     *
     * @param viewId  id of the TextView
    ...
    public CommonViewHolder setText(int viewId, SpannableString content) {
        View view = getView(viewId);
...
////        Glide.with(mContext).asBitmap().load(url).into((ImageView)getView(viewId));
////        return this;
////    }
