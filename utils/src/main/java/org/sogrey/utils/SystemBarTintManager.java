...
public class SystemBarTintManager {
    ...
    static {
        ...
        // See https://github.com/android/platform_frameworks_base/blob/master/policy/src/com
      // /android/internal/policy/impl/PhoneWindowManager.java#L1076
    ...
    public static class SystemBarConfig {
        ...
        private static final String
                NAV_BAR_HEIGHT_LANDSCAPE_RES_NAME="navigation_bar_height_landscape";
        ...
        private SystemBarConfig(Activity activity,boolean translucentStatusBar,boolean
                traslucentNavBar) {
